<template>
    <div >
        ...
        <div class="container">
            <div class="row">
                <ul class="list-group">
                    <li class="list-group-item"><router-link to="/example-test">Tests of the test component </router-link></li>
                    <li class="list-group-item"><router-link to="/example-isalive">Tests of the IsAlive component</router-link></li>
                    <li class="list-group-item"><router-link to="/example-simple-component-svg">Tests of the SimpleComponentSVG component</router-link></li>
                    <li class="list-group-item"><router-link to="/example-sleep-and-reactivation-ds">Tests of the SleepAndReactivationDS component</router-link></li>
                    ...
                    <li class="list-group-item"><router-link to="/calendar">Test Calendar component</router-link></li>
                </ul>
            </div>
        </div>
    </div>
