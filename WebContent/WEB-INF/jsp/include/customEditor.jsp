        ...
        this.save = function() {
            ...
            if (customEditor.typeName == "alarmlist")
            {
            	ViewDwr.saveAlarmListComponent(
                      ...
                      $get("customEditorAlarmListWidth"),
                      $get("customEditorAlarmListIdColumn"),
                      $get("customEditorAlarmListAlarmLevelColumn"),
                      $get("customEditorAlarmListTimestampColumn"),
                      $get("customEditorAlarmListInactivityColumn"),
                      $get("customEditorAlarmListAckColumn"), 
