...
<script type="text/javascript" language="javascript" src="resources/systems_settings.js"></script> 
  ...
  <div class="borderDiv marB marR" style="float:left">
       <table width="100%">
          <tr>
             <td>
               <span class="smallTitle">Layer Detail</span>
             </td>
             <td align="right">
               <tag:img id="saveLayerDetailToDB" png="save" onclick="saveLayerDetail();" title="Info.save"/>
             </td>
          </tr> 
          <tr>
            <td>
              <button type="button" data-toggle="custom__modal" data-target="createLayer">Add New Layer</button>
            </td>
            <td>
              <button type="button" data-toggle="custom__modal" data-target="allLayers">Show All Layer</button>
            </td>
          </tr>
       </table>
  </div>
  ...
  <!--added for layer information-->
  <div class="custom__modal" id="allLayers">
    <!-- Modal content -->
    <div class="modal-content">
      <div class="modal-header">
        <span class="close">&times;</span>
        <h2 class="m-title">All Layers</h2>
      </div>
      <div class="modal-body">
        <table class="reset__table">
          <thead>
            <tr>
              <th>Name</th>
              <th>Description</th>
          ...
          <tbody>
            <!-- <tr>
              <td width="20%">
                <span class="detail__layername">Layer 1</span>
              </td>
              <td>
                <span class="toggle__description">lorem Fugiat proident eiusmod fugiat reprehenderit nisi ex sunt veniam laboris nostrud qui nisi eu in. Eiusmod do aliqua tempor est. Est cupidatat ea et amet eiusmod sunt duis. Mollit laborum velit consequat excepteur eiusmod cupidatat voluptate ad aliqua culpa eu in. Pariatur cupidatat dolore aliquip commodo sunt occaecat duis pariatur. Tempor id occaecat do eu do officia laborum deserunt sit sint pariatur irure. Adipisicing est nisi labore pariatur minim consectetur deserunt voluptate do enim est do.</span>
              </td>
              <td>
                <img class="editLayerDetail" src="images/pencil.png" alt="Edit" title="Edit layer" data-toggle="custom__modal" data-target="editLayer" onclick="setupEditedLayerValues(event)" border="0" width="20"> 
                <svg class="deleteLayerDetail"  height="30px" viewBox="-40 0 427 427.00131" width="30" onclick="deleteSelectedLayerInfo(event)"><title>Delete layer</title><path d="m232.398438 154.703125c-5.523438 0-10 4.476563-10 10v189c0 5.519531 4.476562 10 10 10 5.523437 0 10-4.480469 10-10v-189c0-5.523437-4.476563-10-10-10zm0 0"/><path d="m114.398438 154.703125c-5.523438 0-10 4.476563-10 10v189c0 5.519531 4.476562 10 10 10 5.523437 0 10-4.480469 10-10v-189c0-5.523437-4.476563-10-10-10zm0 0"/><path d="m28.398438 127.121094v246.378906c0 14.5625 5.339843 28.238281 14.667968 38.050781 9.285156 9.839844 22.207032 15.425781 35.730469 15.449219h189.203125c13.527344-.023438 26.449219-5.609375 35.730469-15.449219 9.328125-9.8125 14.667969-23.488281 14.667969-38.050781v-246.378906c18.542968-4.921875 30.558593-22.835938 28.078124-41.863282-2.484374-19.023437-18.691406-33.253906-37.878906-33.257812h-51.199218v-12.5c.058593-10.511719-4.097657-20.605469-11.539063-28.03125-7.441406-7.421875-17.550781-11.5546875-28.0625-11.46875h-88.796875c-10.511719-.0859375-20.621094 4.046875-28.0625 11.46875-7.441406 7.425781-11.597656 17.519531-11.539062 28.03125v12.5h-51.199219c-19.1875.003906-35.394531 14.234375-37.878907 33.257812-2.480468 19.027344 9.535157 36.941407 28.078126 41.863282zm239.601562 279.878906h-189.203125c-17.097656 0-30.398437-14.6875-30.398437-33.5v-245.5h250v245.5c0 18.8125-13.300782 33.5-30.398438 33.5zm-158.601562-367.5c-.066407-5.207031 1.980468-10.21875 5.675781-13.894531 3.691406-3.675781 8.714843-5.695313 13.925781-5.605469h88.796875c5.210937-.089844 10.234375 1.929688 13.925781 5.605469 3.695313 3.671875 5.742188 8.6875 5.675782 13.894531v12.5h-128zm-71.199219 32.5h270.398437c9.941406 0 18 8.058594 18 18s-8.058594 18-18 18h-270.398437c-9.941407 0-18-8.058594-18-18s8.058593-18 18-18zm0 0"/><path d="m173.398438 154.703125c-5.523438 0-10 4.476563-10 10v189c0 5.519531 4.476562 10 10 10 5.523437 0 10-4.480469 10-10v-189c0-5.523437-4.476563-10-10-10zm0 0"/></svg>
              </td>
            </tr> -->
          </tbody>
        </table>
  ...
  <div class="custom__modal" id="createLayer">
    <!-- Modal content -->
    <div class="modal-content">
      <div class="modal-header">
        <span class="close">&times;</span>
        <h2 class="m-title">Create New Layer</h2>
      </div>
      <div class="modal-body">
        <p>
        <label>Layer Name <span class="required">*</label> &nbsp;&nbsp;<input type="text" id="LayerName" placeholder="Please enter layer name."></p>
        <p><label>Layer Description <span class="required">*</label></label><textarea class="textarea" id="LayerDesc" rows="3" placeholder="Please enter description"></textarea></p>
      </div>
      <div class="modal-footer text-right">
        <button type="button" onclick="submitNewLayer()">Save</button>
      </div>
    </div>
  </div>
  <div class="custom__modal" id="editLayer">
    <!-- Modal content -->
    <div class="modal-content">
      <div class="modal-header">
        <span class="close">&times;</span>
        <h2 class="m-title">Edit Layer</h2>
      </div>
      <div class="modal-body">
        <input type="hidden" id="EditedLayerId">
        <p><label>Layer Name <span class="required">*</label> &nbsp;&nbsp;<input type="text" id="EditedLayerName" placeholder="Please enter layer name."></p>
        <p><label>Layer Description <span class="required">*</label></label><textarea class="textarea" id="EditedLayerDesc" rows="3" placeholder="Please enter description"></textarea></p>
      </div>
      <div class="modal-footer text-right">
        <button type="button" onclick="submitEditedLayer()">Update</button>
      </div>
    </div>
  </div>
  <!--end here-->
