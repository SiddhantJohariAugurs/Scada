  ...
  <table>
    ...
    <tbody id="scalingSection" style="display:none;">
	    <tr>
          ...
          <fmt:message key="pointEdit.logging.scaling.multipyFactor"/> <input id="multiplyFactor" type="text" name="multiplyFactor" value="${form.multiplyFactor}" class="formShort"/>
	      </td>
	      <td class="formError">
