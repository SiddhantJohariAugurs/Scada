...
<link/home/jdressler/projects/scada-lts/WebContent/resources/dygraphs/docs/home/jdressler/projects/scada-lts/WebContent/resources/dygraphs/docs
	href="resources/npm/bootstrap/dist/css/bootstrap.min.css"
	rel="stylesheet" type="text/css">
<link
	href="resources/npm/jquery.fancytree/dist/skin-bootstrap/ui.fancytree.min.css"
	rel="stylesheet" type="text/css">
<link
	href="resources/npm/bootstrap3-dialog/dist/css/bootstrap-dialog.min.css"
	rel="stylesheet" type="text/css">

<link
	href="resources/npm/sweetalert2/dist/sweetalert2.css"
	rel="stylesheet" type="text/css">

<script src="resources/npm/vue-jsoneditor/dist/lib/vjsoneditor.min.js"></script>

<link
	href="resources/npm/vue-jsoneditor/dist/lib/vjsoneditor.min.css"
    rel="stylesheet" type="text/css">
...
button.jsoneditor-compact {
  background-images: url("../resources/npm/vue-jsoneditor/dist/docs/img/jsoneditor-icons.bfab7b1.svg");
}
	...
	<div class="container-fluid">
		<div class="row">
			<table width="100%" cellspacing="0" cellpadding="0" border="0"
				id="mainHeader">
				<tr>
					<td><img id="logo" class="logo" src="images/logo.svg"
						alt="Logo" /></td>
					<c:if test="${!simple}">
...
<!-- 							</span> -->
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0">
			...
			<tr>
				<td colspan="2" class="footer" align="center">&copy;2012-2020 VROC.ai All rights reserved. <fmt:message
...
<script src="resources/jQuery/plugins/jquery-ui/js/jquery-ui-1.10.3.custom.min.js"></script>
<script	src="resources/npm/bootstrap/dist/js/bootstrap.min.js"></script>
<script	src="resources/npm/jquery.fancytree/dist/jquery.fancytree-all.min.js"></script>
<script	src="resources/npm/bootstrap3-dialog/dist/js/bootstrap-dialog.min.js"></script>
<script src="resources/sockjs-0.3.4.js"></script>
<script src="resources/stomp.js"></script>

<!-- <script src="resources/npm/axios/dist/axios.min.js"></script>
<script src="resources/npm/vue/dist/vue.min.js"></script>
<script src="resources/npm/vue-axios/dist/vue-axios.min.js"></script>-->
...
<script src="resources/npm/vue-jsoneditor/dist/lib/vjsoneditor.min.js"></script>
<script src="resources/npm/vue-jsoneditor/dist/lib/vjsoneditor.min.css"></script>
