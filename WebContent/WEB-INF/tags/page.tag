...
<head>
  ...
  <meta name="Copyright" content="WebSCADA &copy;2020"/>
  <meta name="DESCRIPTION" content="WebSCADA Software"/>
  <meta name="KEYWORDS" content="WebSCADA Software"/>
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" id="mainHeader">
  <tr>
    <td><img id="logo" src="images/logo.svg" alt="Logo" class="logo"/></td>
    <c:if test="${!simple}">
      ...
      <td align="right">
        ...
        <div style="display:inline;" class="ptr" onmouseover="showMenu('styleEdit', -40, 10);">
          ...
          <div id="styleEdit" style="visibility:hidden;left:0px;top:15px;" class="labelDiv" onmouseout="hideLayer(this)">
            <a class="ptr" id="stylesheet1">Default WebSCADA Theme </a><br/>
            <a class="ptr" id="stylesheet2">Modern WebSCADA Theme</a><br/>
        </div>
        </div>
...
<div class="footer">
    <span>&copy;2012-2020 VROC.ai <fmt:message key="footer.rightsReserved"/><span>
</div>
