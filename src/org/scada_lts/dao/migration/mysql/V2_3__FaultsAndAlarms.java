...
public class V2_3__FaultsAndAlarms implements SpringJdbcMigration {
    ...
    private void addMapDataToView(JdbcTemplate jdbcTmp) throws Exception {
        jdbcTmp.execute("ALTER TABLE mangoViews ADD mapData VARCHAR(1000);");
    }
}