...
public class DataPointService implements MangoDataPoint {
	...
	@Override
	public List<DataPointVO> getSchedules(Integer dataSourceId, String startPrefix, String endPrefix, String valuePrefix) {
		return dataPointDAO.getSchedule(dataSourceId, startPrefix, endPrefix, valuePrefix);
	}
	...
	public void save(String value, Integer id, int typePointValueOfREST ) {
		PointValueTime pvt = new PointValueDAO4REST().save(value, typePointValueOfREST, id);
		
		DataPointRT dpRT = Common.ctx.getRuntimeManager().getDataPoint(id);
