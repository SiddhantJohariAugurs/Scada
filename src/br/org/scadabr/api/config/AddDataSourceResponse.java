...
public class AddDataSourceResponse  implements java.io.Serializable {
    /**
	 * 
	 */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AddDataSourceResponse)) return false;
        AddDataSourceResponse other = (AddDataSourceResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AddDataSourceResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://config.api.scadabr.org.br", ">AddDataSourceResponse"));
