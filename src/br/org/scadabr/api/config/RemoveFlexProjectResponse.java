/**
 * RemoveFlexProjectResponse.java
 *
...
public class RemoveFlexProjectResponse  implements java.io.Serializable {
    /**
	 * 
	 */
    ...
    public RemoveFlexProjectResponse() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RemoveFlexProjectResponse)) return false;
        RemoveFlexProjectResponse other = (RemoveFlexProjectResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RemoveFlexProjectResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://config.api.scadabr.org.br", ">RemoveFlexProjectResponse"));
