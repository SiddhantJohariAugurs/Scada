...
public class RemoveDataPointResponse  implements java.io.Serializable {
    /**
	 * 
	 */
    ...
    public RemoveDataPointResponse() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RemoveDataPointResponse)) return false;
        RemoveDataPointResponse other = (RemoveDataPointResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RemoveDataPointResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://config.api.scadabr.org.br", ">RemoveDataPointResponse"));
