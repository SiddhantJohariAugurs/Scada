...
import ai.vroc.event.UnsolicitedMessageListener;
...
public class DNP3Master {
	...
	/**
	 * Analog variance 1 - 32 bit integer
	 * @param index
	 * @param value
	 * @throws Exception
	 */
	...
	/**
	 * Analog variance 2 - 16 bit integer
	 * @param index
	 * @param value
	 * @throws Exception
	 */
	public void sendAnalogCommand(int index, short value) throws Exception {
		user.sendSynch(user.buildAnalogControlCommand(
				AppFeatures.DIRECT_OPERATE, index, value));
	}
	
	/**
	 * Analog variance 3 - 32 bit float
	 * @param index
	 * @param value
	 * @throws Exception
	 */
	public void sendAnalogCommand(int index, float value) throws Exception {
		user.sendSynch(user.buildAnalogControlCommand(
				AppFeatures.DIRECT_OPERATE, index, value));
	}
	
	// Analog variance 4 - 64 bit float
	public void sendAnalogCommand(int index, double value) throws Exception {
		user.sendSynch(user.buildAnalogControlCommand(
				AppFeatures.DIRECT_OPERATE, index, value));
	}
	...
	public void addUnsolicitedMessageListener(UnsolicitedMessageListener listener) {
		user.getAppRcv().addUnsolicitedMessageListener(listener);
	}
