        ...
        try {
            ...
            for (int i = pointIdStart; i < imageBits.length; i++) {
                if (imageBits[i].startsWith("w"))
                    ...
                    PointValueTime lastestValueOutsideSelectionWindow = null;
                    if(from > -1) {
                    	lastestValueOutsideSelectionWindow = pointValueFacade.getPointValueBefore(from);
                    }
                    ...
                    if (dp == null || dp.getName() == null)
                        ...
                        if(data != null && data.size() > 0) {
	                        ...
	                        if(lastestValueOutsideSelectionWindow != null)
	                        	ImageChartUtils.addSecond(ts, from, lastestValueOutsideSelectionWindow.getValue().numberValue());
                        }
                        ...
                        if(data != null && data.size() > 0) {
	                        ...
	                        if(lastestValueOutsideSelectionWindow != null) {
	                        	lastestValueOutsideSelectionWindow.setTime(from);
	                        	ts.addValueTime(lastestValueOutsideSelectionWindow);
	                        }
                        }                                               
