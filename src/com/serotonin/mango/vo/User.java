...
public class User implements SetPointSource, HttpSessionBindingListener,
	...
	private transient boolean singleSignedOn = false;
	...
	public boolean isSingleSignedOn() {
		return singleSignedOn;
	}

	public void setSingleSignedOn(boolean singleSignedOn) {
		this.singleSignedOn = singleSignedOn;
	}
