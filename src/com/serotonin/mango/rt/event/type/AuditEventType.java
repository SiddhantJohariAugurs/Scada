...
public class AuditEventType extends EventType {
    ...
    public static void raisePointValueChangedEvent(int dataPointId, String name, Object newValue) {
        ...
        LocalizableMessage message = new LocalizableMessage("event.audit.changed", username, name, dataPointId, newValue);
        
        
        Map<String, Object> context = new HashMap<String, Object>();
        context.put("point", dataPointId);
        
        AuditEventType type = new AuditEventType(AuditEventType.TYPE_DATA_POINT, dataPointId);
